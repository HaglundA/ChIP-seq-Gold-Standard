...
cd $EPHEMERAL/FEBREFRESH/chipseq/chipseq/
...
for files in ./*UNIQUE.bam; do
  ...
  macs2 callpeak -t $files -c ./SRR2058062.fastq.trimmedAligned.sortedByCoord.out.bam_marked_duplicates.bam --outdir MACS2FINALOUTPUT -n ${bname}
done
